...
setup(
    ...
    data_files=[
        ...
        (f'share/{package_name}/launch', [
            ...
            'launch/rviz2_manipulation_launcher.launch.py',
        ...
        # RViz
        (f'share/{package_name}/config', expand(['config/*.rviz'])),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'arm_controller_waist_cmd_vel = g1pilot.manipulation.arm_controller_waist_cmd_vel:main',
